    ...
    <div style={{
      ...
      <div style={{ padding: '24px 20px', borderBottom: '1px solid #2d4a2d' }}>
        <a href="/" style={{ textDecoration: 'none' }}>
          <p style={{ color: '#c8b97a', fontFamily: 'Georgia, serif', fontSize: '13px', fontWeight: 'bold', letterSpacing: '0.5px', margin: 0 }}>
        ...
        <p style={{ color: '#6a8a6a', fontFamily: 'sans-serif', fontSize: '11px', marginTop: '4px' }}>
          Member Dashboard
        </p>
      </div>
        ...
        {links.map(link => {
          ...
          return (
              ...
              style={{
                ...
                marginBottom: '4px',
                textDecoration: 'none',
                background: isActive ? '#2d4a2d' : 'transparent',
                color: isActive ? '#f5f0e8' : '#b8b09a',
                fontSize: '14px',
      ...
      <div style={{ padding: '16px 20px', borderTop: '1px solid #2d4a2d' }}>
        <a href="/" style={{ color: '#6a8a6a', fontFamily: 'sans-serif', fontSize: '12px', textDecoration: 'none' }}>
          ← Back to Public Site
        </a>
      </div>
    </div>
