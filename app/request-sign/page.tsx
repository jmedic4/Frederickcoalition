...
export default function RequestSign() {
  ...
  const [form, setForm] = useState({
    full_name: '', email: '', phone: '', district: '',
    street_address: '', city: '', zip: '',
    quantity: 1, sponsor_quantity: 0, notes: ''
  })
        ...
        <div style={{ maxWidth: '720px', margin: '0 auto' }}>
          {success ? (
            <div style={{ background: '#fff', border: '1px solid #ddd8cc', borderRadius: '8px', padding: '48px', textAlign: 'center' }}>
              ...
              <p style={{ fontSize: '16px', color: '#5a5040', fontFamily: 'sans-serif', lineHeight: '1.6', maxWidth: '400px', margin: '0 auto 24px' }}>
                Thank you! Our signs coordinator will contact you within 48 hours to confirm delivery details.
              </p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p style={{ fontSize: '13px', color: '#8a7a6a', fontFamily: 'sans-serif', textAlign: 'center', marginTop: '12px' }}>
                Our signs coordinator will contact you within 48 hours.
              </p>
            </form>
          )}
        </div>
