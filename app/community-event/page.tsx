  ...
  return (
    <main>
      ...
      <section style={{ padding: '64px 40px', background: '#2d4a2d', textAlign: 'center' }}>
        <p style={{ fontSize: '11px', letterSpacing: '3px', color: '#c8b97a', fontFamily: 'sans-serif', textTransform: 'uppercase', marginBottom: '24px' }}>
          Watch the Full Event
        </p>
        {/* REPLACE THE DIV BELOW WITH YOUR YOUTUBE EMBED WHEN READY */}
        {/* <iframe width="100%" style={{maxWidth:'860px', aspectRatio:'16/9'}} src="https://www.youtube.com/embed/YOUR_VIDEO_ID" allowFullScreen /> */}
        <div style={{ maxWidth: '860px', margin: '0 auto', aspectRatio: '16/9', background: '#1a2e1a', borderRadius: '6px', border: '1px solid #3d5a3d', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ textAlign: 'center' }}>
            <p style={{ fontSize: '48px', marginBottom: '16px' }}>▶</p>
            <p style={{ color: '#c8b97a', fontFamily: 'Georgia, serif', fontSize: '20px', marginBottom: '8px' }}>Video Coming Soon</p>
            <p style={{ color: '#b8b09a', fontFamily: 'sans-serif', fontSize: '14px' }}>The full event recording will be posted here shortly.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '64px 40px', background: '#f5f0e8' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <p style={{ fontSize: '11px', letterSpacing: '3px', color: '#4a7c3f', fontFamily: 'sans-serif', textTransform: 'uppercase', marginBottom: '12px', textAlign: 'center' }}>
      ...
      <section style={{ padding: '64px 40px', background: '#faf8f2' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: '36px', color: '#1a2e1a', fontFamily: 'Georgia, serif', marginBottom: '48px', textAlign: 'center' }}>
      ...
      <section style={{ padding: '80px 40px', background: '#1a2e1a', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <a href="/request-sign" style={{ background: 'transparent', color: '#f5f0e8', border: '1px solid #c8b97a', padding: '14px 28px', fontSize: '14px', fontFamily: 'sans-serif', borderRadius: '4px', textDecoration: 'none' }}>
            Request a Yard Sign →
          </a>
        </div>
      </section>
